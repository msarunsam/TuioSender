...
namespace BGAPI2
{
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * \fn        erase(iterator& _where)
        * \brief     This function deletes an object from the system list.
        * \param     _where This iterator points to the object that is supposed to be deleted.
        * \return    iterator This function delivers an iterator on the next object.
        * \exception Exceptions::ObjectInvalidException The calling object is not valid.
        * \exception Exceptions::LowLevelException GenTL Producer error. Use IException::GetErrorDescription or check trace output for more detailed error information.
        */
        ...
        /**
        * \fn        erase(const String& _keyval)
        * \brief     This function deletes an object from the system list.
        * \param     _keyval The ID to the object to be deleted.
        * \return    bo_uint64 This function delivers the number of deleted objects.
        * \exception Exceptions::ObjectInvalidException The calling object is not valid.
        * \exception Exceptions::LowLevelException GenTL Producer error. Use IException::GetErrorDescription or check trace output for more detailed error information.
        */
        bo_uint64 erase(const String& _keyval);
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * \fn        erase(iterator& _where)
        * \brief     This functions deletes an object from the interface list.
        * \param     _where This iterator points to the object that is supposed to be deleted.
        * \return    iterator This function delivers an iterator on the next object.
        * \exception Exceptions::ObjectInvalidException The calling object is not valid.
        * \exception Exceptions::LowLevelException GenTL Producer error. Use IException::GetErrorDescription or check trace output for more detailed error information.
        */
        ...
        /**
        * \fn        erase(const String& _keyval)
        * \brief     This function deletes an object from the interface list.
        * \param     _keyval The ID to the object that is supposed to be deleted.
        * \return    bo_uint64 This function delivers the number of deleted objects.
        * \exception Exceptions::ObjectInvalidException The calling object is not valid.
        * \exception Exceptions::LowLevelException GenTL Producer error. Use IException::GetErrorDescription or check trace output for more detailed error information.
        */
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * \fn        erase(iterator& _where)
        * \brief     This function deletes an object from the device list.
        * \param     _where This iterator points to the object to be deleted.
        * \return    iterator This function delivers an iterator on the next object.
        * \exception Exceptions::ObjectInvalidException The calling object is not valid.
        * \exception Exceptions::LowLevelException GenTL Producer error. Use IException::GetErrorDescription or check trace output for more detailed error information.
        */
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * \fn        erase(iterator& _where)
        * \brief     This function deletes an object from the DataStream list.
        * \param     _where This iterator points to the object which is to be deleted.
        * \return    iterator This function delivers an iterator on the next object.
        * \exception Exceptions::ObjectInvalidException The calling object is not valid.
        */
        iterator erase(iterator& _where);
    ...
    */
    ...
    public:
        ...
        * \fn        erase(const String& _keyval)
        * \brief     This function removes a Buffer object from the Buffer list.
        * \param     _keyval The ID to the object which is to be deleted.
        * \return    bo_uint64 This function delivers the number of deleted objects.
        * \exception Exceptions::ObjectInvalidException The calling object is not valid.
        */
        bo_uint64 erase(const String& _keyval);
    ...
    namespace Events
    {
        ...
        */
        ...
        public:
            ...
            * \brief     This function cancels the current waiting operation on the GetFilledBuffer function.
            * \exception Exceptions::NotInitializedException The BGAPI object is not open.
            * \exception Exceptions::ObjectInvalidException The calling object is not valid.
            */
    ...
    */
    ...
    public:  
        ...
        * \exception Exceptions::ObjectInvalidException The calling object is not valid.
        * \remarks   The stacked mode is a high-performance method for transmitting write commands (control commands) to the device. The control commands were packed into one packet and transmitted as a concatenated command. The stacked mode is started by calling the function Device::StartStacking. All following control commands were collected and will not be transmitted until the calling of Device::WriteStack. After calling Device::WriteStack the stacked mode is stopped.
        */    
        void StartStacking();
